...
public class Copy2ByFile<T> {
    public void saveObject(String filename, T o) throws IOException {
        try {
    ...
    public T readObject(String filename) throws IOException, ClassNotFoundException {
